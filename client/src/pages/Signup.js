        ...
        <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
          ...
          <div className="md:flex md:flex-col md:justify-center lg:pr-16">
            ...
            <div className="relative mt-4 outline-transparent outline">
              <input name="name" placeholder=" " className="block w-full pb-2 pl-3 text-lg text-gray-200 placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" required onChange={(e) => { setUser({ ...user, name: e.target.value }) }} />
              <label className="absolute top-0 p-2 text-lg text-gray-200 duration-300 md:text-lg -z-1 origin-0">Full Name</label>
            </div>
            ...
            <div className="w-full block bg-gradient-to-r from-purple-400 via-purple-500 to-pink-500 hover:shadow-lg font-semibold rounded-lg px-4 py-3 border border-gray-300 cursor-pointer shadow-lg my-8" onClick={signupUser}>
            ...
            {/* <div className="grid justify-center grid-cols-1 gap-4 mx-4 md:grid-cols-2">
              ...
              <Link to="/"><button type="button" className="h-12 px-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn my-6 bg-red-50 bg-gradient-to-r from-purple-400 via-purple-500 to-pink-500 hover:shadow-lg w-52">Sign In</button></Link>
